# Task B-F4：IREquivalenceChecker 接口定义（优化版）
...
TEST(IREquivalenceCheckerTest, TypeEquivalent) {
  IRTypeContext Ctx;
  auto* Int32_A = Ctx.getIntegerType(32);
  auto* Int32_B = Ctx.getIntegerType(32);
  EXPECT_TRUE(IREquivalenceChecker::isTypeEquivalent(Int32_A, Int32_B));
}

TEST(IREquivalenceCheckerTest, TypeNotEquivalent) {
  IRTypeContext Ctx;
  auto* Int32 = Ctx.getIntegerType(32);
  auto* Int64 = Ctx.getIntegerType(64);
