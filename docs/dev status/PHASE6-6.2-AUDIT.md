...
--CodeGen 层已有 EmitCondVarDecl 支持
--但 Parse 层 parseIfStatement/parseSwitchStatement/parseWhileStatement 只调用 parseExpression()
--Sema 层 ActOnIfStmt/ActOnSwitchStmt/ActOnWhileStmt 始终传 nullptr 作为 CondVar（P2）
